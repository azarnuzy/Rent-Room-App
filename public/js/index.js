...
$(document).ready( function() {
  ...
  $('#datereset').click(function() {
   ...
   $('#datebtn').click(function(){
       ...
       const tr = document.querySelectorAll('.rent-detail');
       for(let i=0; i<tr.length; i++) {
         const start_detail_time = document.querySelectorAll('.detail-rent-room_start-time')[i].innerText.split(' ')[0];
         start_detail_time != value ? tr[i].style.display = 'none' : tr[i].style.display = 'table-row'
       }
   })});